...
- Use `make testlint` for using the shipped luacheck program to lint all tests. It is also [supported by syntastic](https://github.com/scrooloose/syntastic/wiki/Lua:---luacheck).
