...
Neovim and the Python modules are available in the official Fedora repository:
...
If you are using nix as a standalone package manager, replace nixOS in the above commands with nixpkgs.
