...
2. Unzip `Neovim.zip` in `C:/Program Files (x86)/Neovim/` (If you can't or don't want to install in `C:/Program Files (x86)/Neovim/` set $VIMRUNTIME to the correct folder + /share/nvim/runtime)
