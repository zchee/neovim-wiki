...
[7.4.282](https://code.google.com/p/vim/source/detail?r=6d0a1132dd71c7f55f7ed53fe99e97c79bfd05a4) | Test 97 fails on Mac. | ✗
...
[7.4.284](https://code.google.com/p/vim/source/detail?r=3c35ca9666e88a8024af6dab585b8e79ab295f83) | Setting 'langmap' in the modeline can cause trouble.  E.g. mapping	    ":" breaks many commands. (Jens-Wolfhard Schicke-Uffmann) | ✗
...
[7.4.286](https://code.google.com/p/vim/source/detail?r=be19015ef43cc17825929206790696c2e716035d) | Error messages are inconsistant. (ZyX) | ✗
[7.4.287](https://code.google.com/p/vim/source/detail?r=66fe4908b649ba18426af6f69e8ccb01b487dcbd) | Patches for .hgignore don't work, since the file is not in the	    distribution.	    next version. | ✗
[7.4.288](https://code.google.com/p/vim/source/detail?r=7965cb6a435ae1ea331c7c2f8740d3d4c3625f3b) | When 'spellfile' is set the screen is not redrawn. | ✗
[7.4.289](https://code.google.com/p/vim/source/detail?r=99374096a76b96d1128f5e6aa1fa92b4ba70fee9) | Pattern with repeated backreference does not match with new regexp	    engine. (Urtica Dioica)	    the state list. | ✗
[7.4.290](https://code.google.com/p/vim/source/detail?r=b871734bf54ea185dbd2cc759d86dbfbe21cde26) | A non-greedy match followed by a branch is too greedy. (Ingo	    Karkat)	    differs. | ✗
[7.4.291](https://code.google.com/p/vim/source/detail?r=b5972833add9de714f4651e26fd9ea63ec4a880c) | Compiler warning for int to pointer of different size when DEBUG	    is defined. | ✗
[7.4.292](https://code.google.com/p/vim/source/detail?r=60cdaa05a6ad31cef55eb6b3dc1f57ecac6fcf79) | Searching for "a" does not match accented "a" with new regexp	    engine, does match with old engine. (David Bürgin)	    "ca" does not match "ca" with accented "a" with either engine.	    also for single-byte patterns. | ✗
...
[7.4.296](https://code.google.com/p/vim/source/detail?r=53b87d790574b6d19034fb3390987c22fb928c58) | Can't run tests on Solaris. | ✗
...
[7.4.298](https://code.google.com/p/vim/source/detail?r=156f891d520e93eab5d3ce02784660fb13a3b0d3) | Can't have a funcref start with "t:". | ✗
[7.4.299](https://code.google.com/p/vim/source/detail?r=daebf8ce66089c0c179fb436ceba359ef8d593d5) | When running configure twice DYNAMIC_PYTHON_DLL may become empty. | ✗
[7.4.300](https://code.google.com/p/vim/source/detail?r=1157079ca5f167bcf8746dfc52ea5a85e6c87a30) | The way config.cache is removed doesn't always work. | ✗
[7.4.301](https://code.google.com/p/vim/source/detail?r=8cb42aa3c4957a543e5dffe307475dbab969612f) | Still a scrolling problem when loading a session file. | ✗
[7.4.302](https://code.google.com/p/vim/source/detail?r=df141c80ea3a1ffcbf82d05c1314675231fcfa75) | Signs placed with 'foldcolumn' set don't show up after filler	    lines. | ✗
[7.4.303](https://code.google.com/p/vim/source/detail?r=463ef551e9f62b63ac3f85f1f297b668b14bcd09) | When using double-width characters the text displayed on the	    command line is sometimes truncated. | ✗
[7.4.304](https://code.google.com/p/vim/source/detail?r=fed2e0967f8133ba9a44b0701f151c8d88c4896a) | Cannot always use Python with Vim. | ✗
[7.4.305](https://code.google.com/p/vim/source/detail?r=63e7cc62402dffb180b40c04c63ceeb5f53957d7) | Making 'ttymouse' empty after the xterm version was requested	    causes problems. (Elijah Griffin)	    requested.  Also don't request the xterm version when DEC mouse	    was enabled. | ✗
...
[7.4.319](https://code.google.com/p/vim/source/detail?r=a076237d1c3849535681e82946a9041ed5525d7f) | Crash when putting zero bytes on the clipboard.	    encoding. (Naofumi Honda) | ✗
[7.4.320](https://code.google.com/p/vim/source/detail?r=f7bc601823e5c81e2ca412506a42eff9fd790ace) | Possible crash when an BufLeave autocommand deletes the buffer.	    window until autocommands are done. (Yasuhiro Matsumoto) | ✗
[7.4.321](https://code.google.com/p/vim/source/detail?r=c052937aae8ca5082f308b8ff0712c7eccdd30c8) | Can't build with strawberry perl 5.20 + mingw-w64-4.9.0. | ✗
[7.4.322](https://code.google.com/p/vim/source/detail?r=fd96c55d683d76ece4ba01490d9796c13c988cdc) | Using "msgfmt" is hard coded, cannot use "gmsgfmt". | ✗
...
[7.4.325](https://code.google.com/p/vim/source/detail?r=1f288d2475488c3f44c7248e99019e2612580716) | When starting the gui and changing the window size the status line	    may not be drawn correctly.	    Brabandt) | ✗
...
[7.4.327](https://code.google.com/p/vim/source/detail?r=99d8f2d72dcd4b850de81998cc9b1120c8165762) | When 'verbose' is set to display the return value of a function,	    may get E724 repeatedly.	    string after an error. | ✗
...
[7.4.329](https://code.google.com/p/vim/source/detail?r=018df65085f8990c1407442f8c783d4cee72a479) | When moving the cursor and then switching to another window the	    previous window isn't scrolled. (Yukihiro Nakadaira)	    Brabandt) | ✗
[7.4.330](https://code.google.com/p/vim/source/detail?r=f9fa2e506b9f07549cd91074835c5c553db7b3a7) | Using a regexp pattern to highlight a specific position can be	    slow.	    (Alexey Radkov) | ✗
...
[7.4.332](https://code.google.com/p/vim/source/detail?r=8fed02d53b45848b0fff60de13d06858963cfb17) | GTK: When a sign icon doesn't fit exactly there can be ugly gaps.	    (Christian Brabandt) | ✗
