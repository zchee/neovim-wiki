...
- **Legacy system support**: Fixes for legacy systems such as Solaris or Amiga are not needed since they are not supported by neovim.
- (add more...)
...
------------------- | --------------- | ----------
 ...
 [7.4.166](https://code.google.com/p/vim/source/detail?r=5d03c374712128077ac4c342aad02120ed98df70)  | Auto-loading a function for code that won't be executed. (#445) | ✔
