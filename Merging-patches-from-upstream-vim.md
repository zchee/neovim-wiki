...
Visit the [**vim-patch report**](http://neovim.org/doc/build-reports/vimpatch/) to see which patches are needed.
...
------------------- | --------------- | ----------
 ...
 [7.4.201](https://code.google.com/p/vim/source/detail?r=06e5f65c34d8136c3a9d2219429b7eca35cb3a21)  | 'lispwords' is a global option. ([#1068](https://github.com/neovim/neovim/pull/1068))| RFC
...
[7.4.230](https://code.google.com/p/vim/source/detail?r=57ecd7a8c0f052296b41b916eb1ae7f2a9a48b27)  | Error when using ":options". ([#938](https://github.com/neovim/neovim/pull/938)) ([#1062](https://github.com/neovim/neovim/pull/1062))| RFC
[7.4.231](https://code.google.com/p/vim/source/detail?r=0a295a3c9e473512ad3b006a0fb752ad43d19094)  | An error in ":options" is not caught by the tests. ([#1062](https://github.com/neovim/neovim/pull/1062))| RFC
...
[7.4.323](https://code.google.com/p/vim/source/detail?r=238f5027830cad22e17a970483af9b160869cdf3) | Substitute() with zero width pattern breaks multi-byte character. ([#967](https://github.com/neovim/neovim/pull/967)) | ✔
...
[7.4.360](https://code.google.com/p/vim/source/detail?r=761687c6808f4c9c80d33a919a6bb506dfe9f674) | In a regexp pattern a "$" followed by \v or \V is not seen as the end-of-line. | ✗
[7.4.361](https://code.google.com/p/vim/source/detail?r=a97e5b9dbc26800830e46cf3c1aa6efbfe258097) | Lots of flickering when filling the preview window for 'omnifunc'. | ✗
[7.4.362](https://code.google.com/p/vim/source/detail?r=7fa2bed947fde3514a700c96861a537d816d6fd4) | When matchaddpos() uses a length smaller than the number of bytes in the (last) character the highlight continues until the end of the line. | ✗
[7.4.363](https://code.google.com/p/vim/source/detail?r=ff3816167b73fde35017d364b1a820014cd42e76) | In Windows console typing 0xCE does not work. | ✗
[7.4.364](https://code.google.com/p/vim/source/detail?r=7b324826757595b21b0410a7b6f00227d73c655f) | When the viminfo file can't be renamed there is no error message. (Vladimir Berezhnoy) | ✗
[7.4.365](https://code.google.com/p/vim/source/detail?r=4625fa27ba6f5b06294675b7f0d1bf8ae8f249fb) | Crash when using ":botright split" when there isn't much space. | ✗
[7.4.366](https://code.google.com/p/vim/source/detail?r=ad775b58706587b6acfb0bb2c732e184efe4f778) | Can't run the linebreak test on MS-Windows. | ✗
...
[7.4.375](https://code.google.com/p/vim/source/detail?r=5a5492d676ab1e8334aa86ec552e7e33ee8828e1) | Test 63 fails when run with GUI-only Vim. | ✗
[7.4.376](https://code.google.com/p/vim/source/detail?r=c3bb76e5b2355c57d7f89997aa9e125e46afdea1) | Popup menu flickers too much. | ✗
